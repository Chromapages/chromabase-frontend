...
import { useLeads, useClients, useDeals, useTasks, useActivities } from '@/hooks';
...
export default function DashboardPage() {
    ...
    const isLoading = leadsLoading || clientsLoading || dealsLoading || tasksLoading || activitiesLoading;
    const error = leadsError || clientsError || dealsError || tasksError || activitiesError;
